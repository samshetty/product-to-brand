...
corpus = ['apple inc.', 'microsoft Corporation', 'honda', 'samsung electronics',  
          'bloomberg llc', 'toyota', 'google', 'facebook', 'pfizer', 'amazon']
corpus_embeddings = embedder.encode(corpus)

queries = ['ipad pro', 'iphone 10 pro', 'kindle e-reader', 'android', 'accord ex', 'windows os',
           'camry le', 'galaxy note phone', 'galaxy note', 'civic'
